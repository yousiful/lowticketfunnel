...
// slug renders the $1.99 book offer, /join-v2 is the two-step order form A/B
// variant of the membership page, and everything else is the public membership
// funnel. App is the control in that test, so leave it on the default route.
